...
$('#btnqr').on('click', function () {
	...
	if (levelNum > 0) {
	    ...
	    /************修改抽奖轮次图标************/
	    if (levelNum == 3) { $("#levelImg").attr("src", "images/1_02a.png");}
	    else if (levelNum == 2) { $("#levelImg").attr("src", "images/1_02b.png"); pcount = 30/************指定中奖名单************/ }
	    else if (levelNum == 1) { $("#levelImg").attr("src", "images/1_02c.png");}		
	}
