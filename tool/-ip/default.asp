...
asaistr="<h1 style=color:#F00;>����ѯ��IP["&asaiip&"]�����أ�"&asaigs&"</h1>"
end if
...
asaimystr="<p style=color:#0F0;>����ǰ��IP["&asaimyip&"]�����أ�"&asaimygs&"</p>"
if asaistr="" then
asaiip=asaimyip
asaigs=asaimygs
asaistr=asaimystr
...
<html>
<head>
<meta charset="gb2312" /><link rel="shortcut icon" type="image/icon" href="http://x.asai.cc/js/logo/favicon.ico" />
<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=no">
<title><%=asaiip&"������:"&asaigs%>,IP��ѯ,<%=year(date())%>������IP�����ز�ѯ</title>
<meta name="keywords" content="<%=asaiip&"������"&asaigs%>,IP��ѯ,<%=year(date())%>������IP�����ز�ѯ,������վϵͳר��IP��ѯ">
<meta name="description" content="<%=asaiip&"������"&asaigs%>,IP��ѯ,<%=year(date())%>������IP�����ز�ѯ,������վϵͳר��IP��ѯ">
<meta name="copyright" content="<%=asaiip&"������"&asaigs%>,IP��ѯ,<%=year(date())%>������IP�����ز�ѯ,����������,������,Asai.Wang">
</head>
...
<%=asaistr%>
<form method="post" name="ipform" action="./">������Ҫ������IP ��<input type="text" name="ip" size="36" value="<%=asaiip%>"> <input type="submit" value="����λ��"></form>
<%=asaimystr%>
<br><br>����֧��: ���������ҡ�����֧��: <%=WryInfo()%>
<p style="font-size:small;color:#999;">
JS���ô��룺&lt;script charset=&quot;gb2312&quot; src=&quot;http://ip.asai.cc/?ty=1&amp;ip=<s>IP��ַ</s>&quot;&gt;&lt;/script&gt;
<br>AJAX��ȡ��ַ��http://ip.asai.cc/?ty=2&amp;ip=<s>IP��ַ</s>
<br>���Ӳ�ѯ��ַ��http://ip.asai.cc/?<s>IP��ַ</s>
</p>
<%end if%>
<div style="display:none"><br><br><a href="./">��ѯ��ҳ</a> <a href="?pl=1">������ѯ</a></div><br><br><script charset="UTF-8" src="http://x.asai.cc/js/AsaiCount/?http://ip.asai.cc/"></script>
</div>
<script src="http://x.asai.cc/js/gg-link-gb.js"></script>
<script>
...
Class TQQWry
        ...
        Private Sub Class_Initialize
                ...
                LastStartIP         = 0 
                EndIPOff                 = 0 
                QQWryFile = Server.MapPath("qqwry.dat") 'QQ����IP����·����Ҫ��Ϊ���·��
        End Sub
        ' ============================================
        ' IP��ַת��������
        ' ============================================
